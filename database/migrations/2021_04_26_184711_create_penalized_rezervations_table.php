...
class CreatePenalizedRezervationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('penalized_rezervations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('penalized_rezervations');
    }
}
