                                    ...
                                    <table class="text-white" id="tableusers" data-toggle="table" data-search="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="first_name" data-filter-control="select"
                                                    data-sortable="true">First Name</th>
                                                <th data-field="last_name" data-filter-control="input"
                                                    data-sortable="true">Last Name</th>
                                                <th data-field="phone_number" data-filter-control="input"
                                                    data-sortable="true">Phone Number</th>
                                                <th data-field="email" data-filter-control="select"
                                                    data-sortable="true">E-mail</th>
                                            </tr>
                                        </thead>
                                        <tbody class="text-white">
                                            @foreach ($users as $user)
...
<li>
    <div class="uk-section ">
        <div class="container-fluid">
            <h1 style="border-bottom: 3px solid #FFFFFF;width: 40% !important;" class="text-white">All Librarians</h1>
            <div id="toolbar" class="mb-3">
                <select class="form-control">
                    <option value="">Export Basic</option>
                    <option value="all">Export All</option>
            ...
            <table class="text-white" id="table" data-toggle="table" data-search="true" data-filter-control="true"
                data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                <thead>
                    <tr>
                        <th data-field="state" data-checkbox="true"></th>
                        <th data-field="username" data-filter-control="select" data-sortable="true">Username</th>
                        ...
                        <th data-field="phone_number" data-filter-control="select" data-sortable="true">Phone Number
                        </th>
