...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("css/librarian/Notification_Donation.css") }}">
    <link href="{{ asset("css/admin/Manager_Deployment.css") }}" rel="stylesheet">
    ...
    <title>Libshare | Librarian</title>
</head>
<body>
    @yield("content")
</body>
...
<script src="https://unpkg.com/bootstrap-table@1.18.3/dist/bootstrap-table.min.js%22%3E"></script>
<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js%22%3E">
</script>
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js%22%3E">
</script>
