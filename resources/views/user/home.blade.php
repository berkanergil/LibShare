            ...
            <div class="container-fluid mb-5">
                <div class="c-carousel mb-5 m-auto">
                    ...
                    <ul class="c-carousel__slides ">
                        <li>
                            <a href=""><img class="img-bookss overlay" src="{{ asset("images/system/book1.jfif") }}"> </a>
                        </li>
                        <li>
                            <a href=""><img class="img-bookss" src="{{ asset("images/system/book2.jfif") }}" /> </a>
                        </li>
                        <li>
                            <a href=""><img class="img-bookss" src="{{ asset("images/system/book3.jpg") }}" /> </a>
                        </li>
                        <li>
                            <a href=""><img class="img-bookss" src="{{ asset("images/system/book4.jpg") }}" /> </a>
                        </li>
                        <li>
                            <a href=""><img class="img-bookss" src="{{ asset("images/system/book5.jpg") }}" /> </a>
                        </li>
                        <li>
                            <a href=""><img class="img-bookss" src="{{ asset("images/system/book6.jpg") }}" /> </a>
                        </li>
                        <li>
                            <a href=""><img class="img-bookss" src="{{ asset("images/system/book7.jpg") }}"/> </a>
                        </li>
                        <li>
                            <a href=""><img class="img-bookss" src="{{ asset("images/system/book8.jpg") }}" /> </a>
                        </li>
                    </ul>
