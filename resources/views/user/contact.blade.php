            ...
            <div class="container-fluid pl-5">
                <div class="row">
                    <div class="col-lg-4 col-md-12 pl-5  pt-5 ">
                        <h1 class="text-white">Do you have questions and / or suggestions?</h1>
                    ...
                    <div class="col-lg-8 col-md-12 pt-4 col-sm-12 d-sm-block d-md-block">
                        <section class="get-in-touch">
                            ...
                            <form class="contact-form " method="POST" action="{{ route("user_send-email") }}" >
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="form-field col x-50">
                                        <input id="phone" name="email" class="input-text js-input" type="text" required>
                                ...
                                <div class="row ">
                                    <div class="container">
                                        <section class="ftco-section">
                                            <h3 class="text-white" >Choose Your Topic:</h3>
                ...
                <div class="row pt-5 ">
                    <div class="col-lg-4 col-md-12 ">
                        <h1 class ="text-white">Always at your service...</h1>
                    </div>
                    <div class="col-lg-5 pt-5 col-md-12 pt-4 col-sm-12 d-sm-block d-md-block">
                        <div class="row pt-5">
                            <div class="col-md-6 col-sm-12 mb-3">
                                <h4 class="pl-4 text-white">General Questions</h4> <br>
                                <h5 style="font-weight: normal text-white" class="pl-4 text-white">info@libshare.com</h5>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <h4 class="pl-4 text-white">Contact Number</h4> <br>
            
                                <h5 style="font-weight: normal text-white" class="pl-4 text-white">+90 523 918 10 22</h5>
                            </div>
                        </div>
