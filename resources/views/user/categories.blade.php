            ...
            <div id="img_category" class="psuedo_select" name="img_category">
                ...
                <ul id="img_category_options" class="options">
                    ...
                    <li class="option" data-value="{{ $value->id }}"><a class="category-options"
                            href="{{ route("user_categories_id",$value->id) }}">{{ $value->title }}</a></li>
                    @endforeach
        ...
        <div id="mother_cards" class="book-cards">
            @if (count($books)<1) <div class="d-flex text-center align-items-center justify-content-center ">
                ...
                <div class="book-card">
                    ...
                    <div class=" d-flex align-items-center justify-content-center">
                        <button type="button" data-toggle="modal" data-target="#a{{ $book->id }}" class="button-books ">View Details <i class="fas fa-info-circle"></i></button>
                    </div>
                    <div class="modal fade" id="a{{ $book->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document" >
