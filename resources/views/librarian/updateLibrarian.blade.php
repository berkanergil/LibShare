                                                        ...
                                                        <div class="smart-wrap">
                                                                <div class="smart-forms smart-container wrap-2">
                                                                        <form method="post" id="new_post"
                                                                                action="{{ route("librarian_updateLibrarian") }}"
                                                                                        ...
                                                                                        <div class="spacer-b30">
                                                                                                <div class="tagline">
                                                                                                        <span class="font-weight-bold"
                                                                                                                style="color: #2a0845 !important;">User
                                                                                                                Details</span>
                                                                                                </div><!-- .tagline -->
                                                                                        </div>
                                                                                ...
                                                                                <div class="form-footer">
                                                                                        <button style="background: #2a0845 !important;"
                                                                                                type="submit"
                                                                                                class="button btn-primary widgets"><i
                                                                                                        class="far fa-edit"></i>
                                                                                                Update
                                                                                        </button>
                                                                                        <button style="color: #FFFFFF;background: #8261d6 !important;"
                                                                                                type="reset"
                                                                                                class="button"><i
