                            ...
                            <li>
                                <div class="smart-wrap" >
                                    <div class="smart-forms smart-container wrap-2">
                                        <form id="new_post" class="wpcf7-form" action="{{ route("librarian_book",$book) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                            <div class="form-body">
                                                ...
                                                <div class="frm-row">
                                                    <div class="section colm colm6">
                                                        <label for="book_name" class="field prepend-icon">
                                                            <input type="text" name="title" id="book_name" class="gui-input" placeholder="Title of the Book" value="{{ $book->title}}">
                                                    ...
                                                    <div class="section colm colm6">
                                                        <label for="author_name" class="field prepend-icon">
                                                            <input type="text" name="author" id="author_name" class="gui-input" placeholder="Name of the Author" value="{{ $book->author }}">
                                                ...
                                                <div class="section">
                                                    <label for="publish_date" class="field prepend-icon">
                                                        <input type="date" name="publish_date" id="publish_date" class="gui-input" value="{{ $book->publish_date }}">
                                                ...
                                                <div class="section extra-outline">
                                                    <label for="file1" class="field file">
                                                        ...
                                                        <input type="file" class="gui-file" name="file" id="file1" onChange="document.getElementById('uploader1').value = this.value;">
                                                ...
                                                <div class="section">
                                                    <label for="description" class="field prepend-icon">
                                                        <textarea class="gui-textarea" id="description" name="description" >{{ $book->description }}</textarea>
                                                ...
                                                <div class="section colm colm6">
                                                        <label for="author_name" class="field prepend-icon">
                                                            <input type="number" name="stock_number" min="{{ $book->stock_number }}" id="author_name" class="gui-input" placeholder="Stock Number" value="{{ $book->stock_number}}">
                                                            <label for="author_name" class="field-icon"><i class="fa fa-user"></i></label>
                                                        </label>
                                                    </div>
