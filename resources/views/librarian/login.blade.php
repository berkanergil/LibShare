...
{{-- <div class="container-fluid" style="min-height: 100vh">
  <div  class="d-flex align-items-center justify-content-center">
    ...
    <a class="actor-login mr-md-5" href="../Login_Librarian/Login.html">Are You A Admin?</a>
    ...
    <div class="login-box" style="vertical-align: center !important;">
      ...
      <h2 style="opacity: 0.3 !important;">Login | Librarian</h2>
      <form action="{{ route("librarian_login") }}" method="post">
        @csrf
        <div class="user-box">
